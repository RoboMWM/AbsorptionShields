 ...
 * Decided to move this to a new class instead I guess cuz ya
 * Um... it does need to be instantiated I guess... hmmm.
 *
 * I guess I'll just pass the instance around then .-.
 *
 * @author RoboMWM
 */
...
{
    private Method getAbsorptionHearts;
    ...
    public float getShieldHealth(Player player)
    {
        try
        {
            return (float)getAbsorptionHearts.invoke(muhHandle.invoke(player));
        }
        catch (Exception e)
        {
            e.printStackTrace();
    ...
    public void setShieldHealth(Player player, float points)
    {
        try
        {
            setAbsorptionHearts.invoke(muhHandle.invoke(player), points);
        }
        catch (Exception e)
        {
            e.printStackTrace();
